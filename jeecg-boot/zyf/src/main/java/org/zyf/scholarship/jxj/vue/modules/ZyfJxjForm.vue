        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-item label="人数百分比" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input-number v-decorator="['numRate']" placeholder="请输入人数百分比" style="width: 100%" />
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item label="详情文件" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['fileList']" placeholder="请输入详情文件"  ></a-input>
            </a-form-item>
          </a-col>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'jxjName','sortType','numRate','fileList'))
      },
    }
  }
</script>