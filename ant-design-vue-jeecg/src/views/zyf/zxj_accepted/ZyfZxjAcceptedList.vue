<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('助学金发放名单')">导出助学金名单</a-button>

      <!--      <a-button type="primary" icon="download" @click="handleExportXls('助学金申请')">导出</a-button>-->
    ...
    <zyf-zxj-app-modal ref="modalForm" @ok="modalFormOk"></zyf-zxj-app-modal>
  </a-card>
</template>
...
import ZyfZxjAppModal from './modules/ZyfZxjAppModal'
import {getAction} from "@api/manage";
import store from '@/store'

export default {
  name: 'ZyfZxjAcceptedList',
  ...
  data() {
    return {
      ...
      role: "",
      url: {
        list: "/zxj_app/zyfZxjApp/listAccepted",
        delete: "/zxj_app/zyfZxjApp/delete",
        deleteBatch: "/zxj_app/zyfZxjApp/deleteBatch",
        exportXlsUrl: "/zxj_app/zyfZxjApp/exportXls",
        importExcelUrl: "zxj_app/zyfZxjApp/importExcel",
  ...
  methods: {
    ...
    autoInitAccepted() {
      ...
      getAction("/zxj_app/zyfZxjApp/autoInitAccepted").then(res => {
        console.log(res)
        if (res.success) {
    ...
    getSuperFieldList() {
      ...
      fieldList.push({type: 'string', value: 'zxjId', text: '助学金id', dictCode: ''})
